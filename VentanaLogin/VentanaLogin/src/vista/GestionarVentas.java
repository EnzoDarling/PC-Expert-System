...
public class GestionarVentas extends javax.swing.JFrame {
 ...
 String precio,cantidad,tot;  
     public GestionarVentas() {
        ...
        setTitle("Formulario Modificar Ventas");        
        //deshabilitar();
        cargarventas("");
        cargarclientes("");
        cargarproductos("");
...
//        btn_limpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formularios/iconos/1438381989_edit-clear.png"))); // NOI18N
        ...
        btn_limpiar.setBounds(117, 420, 107, 31);
...
//        btn_guardar.setBounds(117, 420, 107, 33);
...
//        btn_eliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formularios/iconos/1414193621_gtk-cancel.png"))); // NOI18N
        ...
        jPanel1.setBounds(0, 30, 250, 550);
...
//        jComboBox1.setBounds(16, 27, 91, 22);
        ...
        labelSesion.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        labelSesion.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelSesion.setText("Conectado");
        labelSesion.setForeground(Color.black);
        getContentPane().add(labelSesion);
        labelSesion.setBounds(0,0,120,24);
        pack();
