...
public class GestionarProductos extends javax.swing.JFrame {
    ...
    public GestionarProductos() {
        ...
        setTitle("Formulario Gestión de Productos");
        cargar("");
    }
    ...
    void eliminar (){
        ...
        if (resp == JOptionPane.YES_OPTION){
	    	if(codd.equals("") || codd==null){
	        	JOptionPane.showMessageDialog(null, "Ingrese un código de barras para borrar un registro",
    ...
    void modificar(){
        ...
        int resp;
        resp = JOptionPane.showConfirmDialog(null,"Los datos seran modificados, ¿Desea hacerlo?","Alerta!", JOptionPane.YES_NO_OPTION);
...
//        btnnuevo.setBounds(5, 280, 80, 33);
        ...
        jButton5.setBounds(186, 250, 80, 33);
        ...
        btnEliminar.setBounds(100, 250, 80, 33);
...
//        jButton2.setBounds(185, 280, 80, 33);
        ...
        btnModificar.setBounds(5, 250, 90, 33);
        ...
        btnvolver.setBounds(5, 350, 80, 33);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 11, 0, 410);
        ...
        t_buscar.setBounds(65, 14, 135, 20);
        ...
        jButton7.setBounds(230, 13, 130, 23);
        ...
        jScrollPane1.setBounds(12, 42, 500, 334);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(340, 10, 610, 397);
        getContentPane().add(jPanel3);
        jPanel3.setBounds(0, 0, 300, 397);
...
//    }//GEN-LAST:event_jButton2ActionPerformed
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(fila>=0){
            ...
            JOptionPane.showMessageDialog(null,"No se seleccioó ninguna fila");
        }      
