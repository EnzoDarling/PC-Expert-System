...
public class RegistrarProductos extends javax.swing.JFrame {
    ...
    void guardar(){
        ...
        if(codd.equals("") || codd==null || insu.equals("") || insu==null || cant.equals("") || cant==null || preci.equals("") || preci==null){
        	...
        	if(codd.length()!=13){
        		JOptionPane.showMessageDialog(null, "El código de barras debe ser de 13 dígitos",
        				  "ERROR_MESSAGE", JOptionPane.ERROR_MESSAGE);
        	}else{
        try {
        PreparedStatement psd= cn.prepareStatement(sql);
        ...
        if(n>0){
            ...
            JOptionPane.showMessageDialog(null, "Compruebe que los datos ingresados sean correctos o ingrese un código de barras diferente");
        }
        cargar("");
        limpiar();
        }
