...
public class Logica {
	...
	final int GERENTEVENTAS=2;
	final int DEPOSITO=3;
	final int USUARIO=4;
...
//	final String PASS_USER="1234";
	   ...
	   private Coordinador miCoordinador;
		...
		private String validarPass(int index, String pass) {
			...
			if (miUsuarioVo!=null) {
				if ( (index==ADMINISTRADOR && index==miUsuarioVo.getTipo() )|| (index==GERENTEVENTAS && index==miUsuarioVo.getTipo() ) || (index==DEPOSITO && index==miUsuarioVo.getTipo() ) || (index==USUARIO && index==miUsuarioVo.getTipo() ) ) {
