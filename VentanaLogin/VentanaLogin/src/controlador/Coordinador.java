...
//		miVentanaEliminarClientes.asignarPrivilegios(usuario);
//		miVentanaEliminarProductos.asignarPrivilegios(usuario);
//		miVentanaEliminarVentas.asignarPrivilegios(usuario);
//		miVentanaModificarClientes.asignarPrivilegios(usuario);
//		miVentanaModificarProductos.asignarPrivilegios(usuario);
//		miVentanaModificarVentas.asignarPrivilegios(usuario);
//		miVentanaRegistrarClientes.asignarPrivilegios(usuario);
//		miVentanaRegistrarProductos.asignarPrivilegios(usuario);
//		miVentanaRegistrarVentas.asignarPrivilegios(usuario);		
	}
