...
public class RegistrarClientes extends javax.swing.JFrame {
    ...
    public RegistrarClientes() {
        ...
        setTitle("Formulario Registrar Cliente");
        cargar("");
        //deshabilitar();
    }
    void limpiar(){
    ...
    void guardar(){
        ...
        if(ivarespon.equals("Seleccione")){
        	JOptionPane.showMessageDialog(null, "Seleccione un contribuyente al IVA",
  				  "ERROR_MESSAGE", JOptionPane.ERROR_MESSAGE);
        	if(cod.equals("") || cod==null || ape.equals("") || ape==null || nomb.equals("") || nomb==null || tel.equals("") || tel==null){
...
//        iva=t_iva.getText();*/
//        String sql="UPDATE clientes SET cli_ap='"+cli_ap.getText()+"', cli_nom= '"+cli_nom.getText()+"', cli_tel='"+cli_tel.getText()+"', cli_iva='"+combocli_iva.getSelectedItem().toString()+"' WHERE cli_nom='"+cli_dni.getText()+"'";
//        int resp;
...
//        btn_climpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formularios/iconos/1438376270_edit-clear.png"))); // NOI18N
        ...
        btn_climpiar.setBounds(104, 262, 80, 35);
...
//        btn_cguardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formularios/iconos/drive_user.png"))); // NOI18N
        ...
        btn_cguardar.setBounds(200, 262, 80, 35);
...
//        btn_nuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formularios/iconos/1414193194_group_add.png"))); // NOI18N
        ...
        btn_nuevo.setBounds(10, 262, 80, 35);
